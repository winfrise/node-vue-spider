...
CREATE TABLE `galleries` (
  ...
  `galleryName` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '相册名',
  ...
  `galleryUrl` mediumtext COLLATE utf8mb4_unicode_ci COMMENT '相册地址',
  `picCount` int(10) NOT NULL DEFAULT '0' COMMENT '图片数量',
  `publishTime` datetime DEFAULT NULL COMMENT '发布的时间',
  PRIMARY KEY (`id`)
...
-- Table structure for galleries
-- ----------------------------
DROP TABLE IF EXISTS `galleryDetails`;
CREATE TABLE `galleryDetails` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键，自增长，唯一',
  `galleryId` int(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '相册ID',
  `description` mediumtext COLLATE utf8mb4_unicode_ci COMMENT '描述',
  `img` mediumtext DEFAULT NULL COMMENT '图片URL',
  `createTime` datetime DEFAULT NULL COMMENT '发布的时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
